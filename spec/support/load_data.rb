...
def load_cycles
  ...
  Plan::Cycle.create!(:code => 'М1', :name => 'Общенаучный цикл', :degree => 'master')
  Plan::Cycle.create!(:code => 'М2', :name => 'Профессиональный цикл', :degree => 'master')
  Plan::Cycle.create!(:code => 'М3', :name => 'Практика и научно-исследовательская работы', :degree => 'master')
  Plan::Cycle.create!(:code => 'М4', :name => 'Итоговая аттестация', :degree => 'master')
end
