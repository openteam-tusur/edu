...
describe Abstracts::Parser do
  ...
  describe "данные записей" do
    ...
    it "поле со знаком ~%" do
      #records.first.summary.should =~ /≠/
      records.first.summary.should include('≠')
    end
